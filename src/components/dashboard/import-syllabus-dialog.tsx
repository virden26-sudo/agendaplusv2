        ...
        {step === 'parsing' ? (
           <div className="flex flex-col items-center justify-center h-80 space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Mapping your semester mission... almost there!</p>
              </div>
           </div>
        ) : step === 'input' ? (
              ...
              <TabsContent value="paste" className="mt-4 space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                      ...
                      <Button variant="link" className="h-auto p-0 text-xs text-primary" onClick={handlePortalClick}>
                  ...
                  />
                  <Button className="w-full bg-gradient-to-r from-primary to-accent hover:opacity-90" onClick={handleTextParse} disabled={!pastedText.trim()}>
