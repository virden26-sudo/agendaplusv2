...
import {Calendar as CalendarIcon, CircleOff, MessageSquare, User as UserIcon} from "lucide-react";
        ...
        <div className="flex flex-col gap-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Participate in your class discussions and don&apos;t miss any
                    ...
                    {discussions.length > 0 ? (
                        <div className="space-y-4">
                            {discussions.map((discussion, index) => (
                                <div key={discussion.id || `disc-${index}`}
