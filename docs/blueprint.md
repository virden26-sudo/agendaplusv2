...
- Accent color: Coral (#FF7F50) to highlight important dates and deadlines.
- Font: 'Roboto' for a clear and readable interface.
- Use minimalist icons to represent different assignment types and subjects.
- Prioritize a clean and organized layout with clear separation of assignments and calendar events.
- Use subtle animations to provide feedback on user interactions and improve the app's responsiveness.